                                    ...
                                    <table className="w-full text-sm text-left text-gray-500 whitespace-nowrap">
                                        ...
                                        <tbody className="divide-y divide-gray-200">
                                            ...
                                            <tr className="">
                                                ...
                                                <td className="md:px-2 pl-[14px] py-3 text-[#217AF7]">
                                                    <Link href="/team/kkr/overview">
                                                        <div className="flex items-center gap-[5px] w-[120px]">
                                                            <Image src="/assets/img/ipl/1.png" width={20} height={20} alt="" />
                                                            <p>KKR<span className="text-[#00B564]"> (Q)</span></p>
                                                        </div>
                                                    </Link>
                                                </td>
                                                ...
                                                <td className="md:px-2 pl-[14px] py-3">
                                                    <div className="ml-auto flex gap-1 items-center">
                                                        <span className="bg-[#13b76dbd] text-white text-[13px] px-[4px] py-[0px] rounded">W</span>
                                                        <span className="bg-[#13b76dbd] text-white text-[13px] px-[4px] py-[0px] rounded">W</span>
                                                        <span className="bg-[#f63636c2] text-white text-[13px] px-[4px] py-[0px] rounded">L</span>
                                                        <span className="bg-[#f63636c2] text-white text-[13px] px-[4px] py-[0px] rounded">L</span>
                                                        <span className="bg-[#13b76dbd] text-white text-[13px] px-[4px] py-[0px] rounded">W</span>
                                                        <button className="arro-button" onClick={() => toggleRow(1)}>
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                fill="none"
                                                                viewBox="0 0 24 24"
                                                                strokeWidth="1.5"
                                                                stroke="currentColor"
                                                                className={`size-4 transition-transform ${expandedRow === 1 ? "rotate-180" : ""}`}
                                                            >
                                            ...
                                            <tr className="">
                                                ...
                                                <td className="md:px-2 pl-[14px] py-3 text-[#217AF7]">
                                                    <Link href="/team/sh/overview">
                                                        <div className="flex items-center gap-[5px]">
                                                            <Image src="/assets/img/ipl/2.png" width={20} height={20} alt="" />
                                                            <p>SH<span className="text-[#00B564]"> (Q)</span></p>
                                                        </div>
                                                    </Link>
                                                </td>
                                                <td className="md:px-2 pl-[14px] py-3">5</td>
                                                ...
                                                <td className="md:px-2 pl-[14px] py-3">
                                                    <div className="ml-auto flex gap-1 items-center">
                                                        ...
                                                        <span className="bg-[#f63636c2] text-white text-[13px] px-[4px] py-[0px] rounded">L</span>
                                                        <span className="bg-[#13b76dbd] text-white text-[13px] px-[4px] py-[0px] rounded">W</span>
                                                        <button className="arro-button" onClick={() => toggleRow(2)}>
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                fill="none"
                                                                viewBox="0 0 24 24"
                                                                strokeWidth="1.5"
                                                                stroke="currentColor"
                                                                className={`size-4 transition-transform ${expandedRow === 2 ? "rotate-180" : ""}`}
                                                            >
                                                                <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                                                            </svg>
                                                        </button>
                                            ...
                                            <tr>
                                                ...
                                                <td className="md:px-2 pl-[14px] py-3">
                                                    <div className="ml-auto flex gap-1 items-center">
                                                        ...
                                                        <span className="flex">
                                                            <button className="arro-button" onClick={() => toggleRow(3)}>
                                                                <svg
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    fill="none"
                                                                    viewBox="0 0 24 24"
                                                                    strokeWidth="1.5"
                                                                    stroke="currentColor"
                                                                    className={`size-4 transition-transform ${expandedRow === 3 ? "rotate-180" : ""}`}
                                                                >
                                                                    <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                                                                </svg>
                                                            </button>
                                            ...
                                            <tr>
                                                ...
                                                <td className="md:px-2 pl-[14px] py-3">
                                                    <div className="ml-auto flex gap-1 items-center">
                                                        ...
                                                        <span className="flex">
                                                            <button className="arro-button" onClick={() => toggleRow(4)}>
                                                                <svg
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    fill="none"
                                                                    viewBox="0 0 24 24"
                                                                    strokeWidth="1.5"
                                                                    stroke="currentColor"
                                                                    className={`size-4 transition-transform ${expandedRow === 4 ? "rotate-180" : ""}`}
                                                                >
                                                                    <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                                                                </svg>
                                                            </button>
                                            ...
                                            <tr>
                                                ...
                                                <td className="md:px-2 pl-[14px] py-3">
                                                    <div className="ml-auto flex gap-1 items-center">
                                                        ...
                                                        <span className="flex">
                                                            <button className="arro-button" onClick={() => toggleRow(5)}>
                                                                <svg
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    fill="none"
                                                                    viewBox="0 0 24 24"
                                                                    strokeWidth="1.5"
                                                                    stroke="currentColor"
                                                                    className={`size-4 transition-transform ${expandedRow === 5 ? "rotate-180" : ""}`}
                                                                >
                                                                    <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                                                                </svg>
                                                            </button>
