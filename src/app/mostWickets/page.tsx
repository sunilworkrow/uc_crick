          ...
          <div className="flex justify-center items-center md:gap-6 gap-4">
            ...
            <div className="text-center">
              <Image
                ...
                width={180} height={213} alt="A Singh"
            ...
            <div className="text-center mb-20">
              <Image
                ...
                width={200} height={250} alt="F Farooqi"
              ...
              <div className="md:w-[85%] mx-auto relative">
                ...
                <div className="absolute h-[31px] md:h-[43px] lg:w-[6px] w-[2px] right-[0px] md:top-[-1px] top-[0px] bg-[white]" />
              </div>
            </div>
            {/* Player 3 */}
            <div className="text-center">
              <Image
                ...
                width={180} height={213} alt="J Bumrah"
                className="lg:h-[213px] md:h-[158px] h-[115px] mx-auto"
              />
              <div className="lg:w-[75%] w-[95%] mx-auto relative">
                <div
