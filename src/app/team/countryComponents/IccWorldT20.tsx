...
export default function IccWorldT20() {
                ...
                <div className="lg:col-span-8 md:col-span-7">
                    ...
                    <div id="tabs" className="mb-4">
                        <div className="flex text-1xl space-x-8 p-2 bg-[#ffffff] rounded-lg overflow-auto">
                            ...
                            <Link href="/team/india/icc-world-t20">
                                <button
                            ...
                            <Link href="/team/india/icc-world-cup">
                                <button
                                    className="font-medium py-2 px-3 whitespace-nowrap"
                                >
                                    Icc world cup
                                        ...
                                        <div className="flex items-center space-x-3">
                                            <div>
                                                <Image
                                                    ...
                                                    width={40} height={40} alt="R sharma (c)"
                                                />
                                            </div>
                                            ...
                                            <Link href="/player/playername/overview">
                                                <div className="relative">
                                                    <Image
                                                        ...
                                                        width={65} height={65} alt="Player Image"
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                                        ...
                                        <Link href="/team/india/test">
                                            <div className="border-[1px] border-[##E2E2E2] rounded-md py-4 px-2 flex flex-col items-center">
                                                <Image
                                                    ...
                                                    width={40} height={40} alt="Pakistan-W"
                                        ...
                                        <Link href="/team/india/test">
                                            <div className="border-[1px] border-[##E2E2E2] rounded-md py-4 px-2 flex flex-col items-center">
                                                <Image
                                                    src="/assets/img/flag/b-2.png"
                                                    width={40} height={40} alt="West Indies-W"
                                                    className="h-[42px] mb-2"
                                                />
                                        ...
                                        <Link href="/team/india/test">
                                            <div className="border-[1px] border-[##E2E2E2] rounded-md py-4 px-2 flex flex-col items-center">
                                                <Image
                                                    ...
                                                    width={40} height={40} alt="Australia-W"
                                                    className="h-[42px] mb-2"
                                                />
                                        ...
                                        <Link href="/team/india/test">
                                            <div className="border-[1px] border-[##E2E2E2] rounded-md py-4 px-2 flex flex-col items-center">
                                                <Image
                                                    ...
                                                    width={40} height={40} alt="Scotland-W"
                                                    className="h-[42px] mb-2"
                                                />
                                        ...
                                        <Link href="/team/india/test">
                                            <div className="border-[1px] border-[##E2E2E2] rounded-md py-4 px-2 flex flex-col items-center">
                                                <Image
                                                    ...
                                                    width={40} height={40} alt="South Africa-W"
                                                    className="h-[42px] mb-2"
                                                />
